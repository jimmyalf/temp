...
<ItemTemplate>
<tr><td colspan="2" style="background-color: rgb(213, 222, 213);"><%# DataBinder.Eval(Container.DataItem, "cCity") %></td></tr>
...
<tr><td><%# DataBinder.Eval(Container.DataItem, "cAddress") %></td>
