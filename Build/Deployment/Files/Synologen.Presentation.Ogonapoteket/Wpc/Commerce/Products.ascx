<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Products.ascx.cs" Inherits="Spinit.Wpc.Commerce.Presentation.Site.Wpc.Commerce.Products" %>

<div id="Cart" runat="server">
	<a href="<%=CheckoutPage %>" class="readmore">Gå till kassan »</a> 
	<p><asp:DropDownList ID="drpProducts" runat="server" />
	</p>
</div>
