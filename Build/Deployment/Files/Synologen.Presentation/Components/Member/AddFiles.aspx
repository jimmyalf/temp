<%@ Page Language="C#" MasterPageFile="~/components/Member/MemberMain.master" AutoEventWireup="true" Inherits="Spinit.Wpc.Member.Presentation.AddFiles" Title="Untitled Page" Codebehind="AddFiles.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="phMember" Runat="Server">
   <div id="dCompMain" class="Components-Member-AddFiles-aspx">
    <div class="fullBox">
    <div class="wrap">
        <h1>Member</h1>
        
		<fieldset>
			<legend>Add files to member <asp:Label ID="lblName" runat="server" /></legend>
