...
xcopy "%1..\BGServiceCoordinator.Task\Output\Synologen.LensSubscription.BGServiceCoordinator.Task.*"		"%1bin\Release\" /R /K /Y /Q
xcopy "%1..\BGServiceCoordinator.Task\Output\Synologen.LensSubscription.BGServiceCoordinator.Task.*.pdb"	"%1bin\Release\" /R /K /Y /Q
xcopy "%1..\BGServiceCoordinator.Task\Output\Synologen.LensSubscription.BGServiceCoordinator.Task.*"		"%1bin\Debug\" /R /K /Y /Q
xcopy "%1..\BGServiceCoordinator.Task\Output\Synologen.LensSubscription.BGServiceCoordinator.Task.*.pdb"	"%1bin\Debug\" /R /K /Y /Q