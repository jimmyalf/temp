/*
type = 0, Needs to be connected to baseusers
type = 1, Does not need to be connected to baseusers
*/

CREATE PROCEDURE spMemberGetByPage
					@type INT,
					@LocationId INT,
					@LanguageId INT,
					@CategoryId INT,
	...
	AS
		BEGIN
			...
			EXEC spMemberGetMemberDynamic @type, @LocationId, @LanguageId, @CategoryId, @SearchString, @OrderBy
