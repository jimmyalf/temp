...
namespace Spinit.Wpc.Synologen.Integration.Test.FrameData
{
	...
	public class Given_a_framebrand : TestBase
	{
		...
		public void Can_edit_persisted_framebrand()
		{
		    ...
		    //Act
		    var editedFrameBrand = Factories.FrameBrandFactory.ScrabmleFrameBrand(SavedFrameBrands.First());
		...
		{
		    //Arrange
		    var frameBrandWithoutConnections = Factories.FrameBrandFactory.GetFrameBrand();
