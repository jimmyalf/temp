...
{	
	public class SynologenOpqFile
	{
		...
		public SynologenOpqFileCategory SynologenOpqFileCategory { get; set; }
		...
		{
			if (!(o is SynologenOpqFile )) {
				return false;
			}

			SynologenOpqFile eq = o as SynologenOpqFile;
