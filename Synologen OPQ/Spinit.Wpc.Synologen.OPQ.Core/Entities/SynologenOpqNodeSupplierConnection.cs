...
{	
	public class SynologenOpqNodeSupplierConnection
	{
		...
		{
			if (!(o is SynologenOpqNodeSupplierConnection )) {
				return false;
			}

			SynologenOpqNodeSupplierConnection eq = o as SynologenOpqNodeSupplierConnection;
