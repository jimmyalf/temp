...
{	
	...
	public partial class EBaseLocation : EntityBase
	{
		...
		[Column(Storage=@"_RelativePath", Name=@"cRelativePath", DbType=@"NVarChar(256)")]
		public string RelativePath
		{
			...
			set {
				if (_RelativePath != value) {
					...
					SendPropertyChanging();
					_RelativePath = value;
					SendPropertyChanged("RelativePath");
		...
		[Column(Storage=@"_SitePath", Name=@"cSitePath", DbType=@"NVarChar(255)")]
		public string SitePath
		{
			get { return _SitePath; }
			set {
				if (_SitePath != value) {
					OnSitePathChanging(value);
					SendPropertyChanging();
					_SitePath = value;
					SendPropertyChanged("SitePath");
					OnSitePathChanged();
				}
			}
		}
		...
		partial void OnFrontTypeChanging(int value);
		partial void OnFrontTypeChanged();
		private int _FrontType;
		[Column(Storage=@"_FrontType", Name=@"cFrontType", DbType=@"Int NOT NULL", CanBeNull=false)]
		public int FrontType
		{
			get { return _FrontType; }
			set {
				if (_FrontType != value) {
					OnFrontTypeChanging(value);
					SendPropertyChanging();
					_FrontType = value;
					SendPropertyChanged("FrontType");
					OnFrontTypeChanged();
				}
			}
		}
		...
		{
			SendPropertyChanging();
			entity.BaseLocation = this;
		}
		
		private void DetachBaseUsers(EBaseUser entity)
		{
			SendPropertyChanging();
			entity.BaseLocation = null;
		}
		#endregion
		...
		public static BaseLocation Convert (EBaseLocation eBaseLocation)
		{
			BaseLocation baseLocation = new BaseLocation
			{
				...
				RelativePath = eBaseLocation.RelativePath,
				SitePath = eBaseLocation.SitePath,
				...
				FrontType = eBaseLocation.FrontType,
			};
		...
		{		
			return new EBaseLocation
			{
				...
				RelativePath = baseLocation.RelativePath,
				SitePath = baseLocation.SitePath,
				...
				FrontType = baseLocation.FrontType,
			};
		}
