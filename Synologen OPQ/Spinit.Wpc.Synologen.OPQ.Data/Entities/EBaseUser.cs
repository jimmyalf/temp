...
{	
	...
	public partial class EBaseUser : EntityBase
	{
		...
		public EBaseUser()
		{
			...
			_tblBaseLocation = default(EntityRef<EBaseLocation>); 
			OnCreated();
		}
		#endregion
		...
		public int? DefaultLocation
		{
			...
			set {
				if (_DefaultLocation != value) {
					if (_tblBaseLocation.HasLoadedOrAssignedValue) {
		...
		public EntitySet<EFileCategory> FileCategories
		{
			get {
		...
		public EntitySet<EFileCategory> FileCategories1
		{
			get {
		...
		public EntitySet<EDocument> Documents1
		{
			get {
		...
		public EntitySet<EDocument> Documents2
		{
			get {
		...
		public EntitySet<EDocument> Documents3
		{
			get {
		...
		[Association(Name=@"tblBaseUser_tblMemberUserConnection", Storage=@"_tblMemberUserConnections", ThisKey=@"Id", OtherKey=@"UserId")]
		...
		[Association(Name=@"tblBaseLocation_tblBaseUser", Storage=@"_tblBaseLocation", ThisKey=@"DefaultLocation", OtherKey=@"Id", IsForeignKey=true)]
		public EBaseLocation BaseLocation
		{
			get {
			...
			set {
				...
				if ((previousValue != value) || (!_tblBaseLocation.HasLoadedOrAssignedValue)) {
					...
					SendPropertyChanged("BaseLocation");
				}
			}
		}
