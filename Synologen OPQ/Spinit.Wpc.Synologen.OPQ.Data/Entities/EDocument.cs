			...
			set {
				...
				if ((previousValue != value) || (!_tblBaseUser.HasLoadedOrAssignedValue)) {
					...
					if (previousValue != null) {
						...
						previousValue.CreatedByDocuments.Remove(this);
					}
					_tblBaseUser.Entity = value;
					if (value != null) {
						value.CreatedByDocuments.Add(this);
			...
			set {
				...
				if ((previousValue != value) || (!_tblBaseUser1.HasLoadedOrAssignedValue)) {
					...
					if (previousValue != null) {
						...
						previousValue.ChangedByDocuments.Remove(this);
					}
					_tblBaseUser1.Entity = value;
					if (value != null) {
						value.ChangedByDocuments.Add(this);
			...
			set {
				...
				if ((previousValue != value) || (!_tblBaseUser2.HasLoadedOrAssignedValue)) {
					...
					if (previousValue != null) {
						...
						previousValue.ApprovedByDocuments.Remove(this);
					}
					_tblBaseUser2.Entity = value;
					if (value != null) {
						value.ApprovedByDocuments.Add(this);
			...
			set {
				...
				if ((previousValue != value) || (!_tblBaseUser3.HasLoadedOrAssignedValue)) {
					...
					if (previousValue != null) {
						...
						previousValue.LockedByDocuments.Remove(this);
					}
					_tblBaseUser3.Entity = value;
					if (value != null) {
						value.LockedByDocuments.Add(this);
