...
{	
	...
	public partial class EDocumentHistory : EntityBase
	{
		...
		[Association(Name=@"tblBaseUser_SynologenOpqDocumentHistory", Storage=@"_tblBaseUser", ThisKey=@"HistoryId", OtherKey=@"Id", IsForeignKey=true)]
		public EBaseUser HistoryIdUser
		{
			get {
		...
		public static DocumentHistory Convert (EDocumentHistory eDocumentHistory)
		{
			DocumentHistory documentHistory = new DocumentHistory
			{
				...
				ShopGroupId = eDocumentHistory.ShopGroupId,
				DocTpeId = eDocumentHistory.DocTpeId,
		...
		{		
			return new EDocumentHistory
			{
				...
				ShopGroupId = documentHistory.ShopGroupId,
				DocTpeId = documentHistory.DocTpeId,
