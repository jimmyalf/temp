...
{	
	...
	public partial class EFile : EntityBase
	{
			...
			set {
				...
				if ((previousValue != value) || (!_tblBaseUser2.HasLoadedOrAssignedValue)) {
					...
					if (previousValue != null) {
						...
						previousValue.Files2.Remove(this);
					}
					_tblBaseUser2.Entity = value;
					if (value != null) {
						value.Files2.Add(this);
			...
			set {
				...
				if ((previousValue != value) || (!_tblBaseUser3.HasLoadedOrAssignedValue)) {
					...
					if (previousValue != null) {
						...
						previousValue.Files3.Remove(this);
					}
					_tblBaseUser3.Entity = value;
					if (value != null) {
						value.Files3.Add(this);
		...
		[Association(Name=@"tblSynologenShopGroup_SynologenOpqFile", Storage=@"_tblSynologenShopGroup", ThisKey=@"ShopGroupId", OtherKey=@"Id", IsForeignKey=true)]
