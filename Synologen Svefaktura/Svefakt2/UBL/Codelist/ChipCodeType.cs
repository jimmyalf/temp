namespace Spinit.Wpc.Synologen.Svefaktura.Svefakt2.UBL.Codelist {
	...
	[System.Xml.Serialization.XmlType(Namespace="urn:oasis:names:tc:ubl:codelist:ChipCode:1:0")]
	public class ChipCodeType {
		...
		public ChipCodeType() {
			codeListIDField = "Chip";
			codeListAgencyIDField = "UBL";
			codeListAgencyNameField = "OASIS Universal Business Language";
			codeListNameField = "Chip";
			codeListVersionIDField = "1.0";
			codeListSchemeURIField = "urn:oasis:names:tc:ubl:codelist:ChipCode:1:0";
			languageIDField = "en";
		}
