...
namespace Spinit.Wpc.Synologen.Svefaktura.Svefakt2.UBL.CommonBasicComponents {
	...
	[System.Xml.Serialization.XmlRoot("cbc:PriceAmount", Namespace="urn:oasis:names:tc:ubl:CommonBasicComponents:1:0", IsNullable=false)]
	public class PriceAmountType : UBLAmountType {
	}
}