...
namespace Spinit.Wpc.Synologen.Svefaktura.Svefakt2.UBL.CommonBasicComponents {
	...
	[System.Xml.Serialization.XmlRoot("cbc:TaxTotalAmount", Namespace="urn:oasis:names:tc:ubl:CommonBasicComponents:1:0", IsNullable=false)]
	public class TaxTotalAmountType : UBLAmountType {
	}
}