...
namespace Synologen.Autogiro.Test
{
	public class AutogiroParserService : IAutogiroParserService {
		...
		public Spinit.Wpc.Synologen.Core.Domain.Model.Autogiro.Recieve.PaymentsFile ReadPayments(string fileContents) { throw new NotImplementedException(); }
		public Spinit.Wpc.Synologen.Core.Domain.Model.Autogiro.Recieve.ConsentsFile ReadConsents(string fileContents) { throw new NotImplementedException(); }
		public Spinit.Wpc.Synologen.Core.Domain.Model.Autogiro.Recieve.ErrorsFile ReadErrors(string fileContents) { throw new NotImplementedException(); }
