...
namespace Spinit.Wpc.Synologen.Svefaktura.Svefakt2.SFTI.CommonAggregateComponents {
	...
	public class SFTIInvoiceLineAllowanceCharge {
		...
		[PropertyValidationRule("SFTIInvoiceLineAllowanceCharge.ChargeIndicator is missing.", ValidationType.RequiredNotNull)]
		...
		/// <remarks/>
		[System.Xml.Serialization.XmlElement(Namespace="urn:oasis:names:tc:ubl:CommonBasicComponents:1:0")]
		[PropertyValidationRule("SFTIInvoiceLineAllowanceCharge.Amount is missing.", ValidationType.RequiredNotNull)]
