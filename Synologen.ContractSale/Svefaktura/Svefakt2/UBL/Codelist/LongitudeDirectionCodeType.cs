...
namespace Spinit.Wpc.Synologen.Svefaktura.Svefakt2.UBL.Codelist {
	...
	[System.Xml.Serialization.XmlType(Namespace="urn:oasis:names:tc:ubl:codelist:LongitudeDirectionCode:1:0")]
	public class LongitudeDirectionCodeType {
		...
		public LongitudeDirectionCodeType() {
			codeListIDField = "Longitude Direction";
			codeListAgencyIDField = "UBL";
			codeListAgencyNameField = "OASIS Universal Business Language";
			codeListNameField = "Longitude Direction";
			codeListVersionIDField = "1.0";
			codeListSchemeURIField = "urn:oasis:names:tc:ubl:codelist:LongitudeDirectionCode:1:0";
			languageIDField = "en";
		}
