...
namespace Spinit.Wpc.Synologen.Svefaktura.Svefakt2.UBL.Codelist {
	...
	[System.Xml.Serialization.XmlType(Namespace="urn:oasis:names:tc:ubl:codelist:SubstitutionStatusCode:1:0")]
	public class SubstitutionStatusCodeType {
		...
		public SubstitutionStatusCodeType() {
			codeListIDField = "Substitution Status";
			codeListAgencyIDField = "UBL";
			codeListAgencyNameField = "OASIS Universal Business Language";
			codeListNameField = "Substitution Status";
			codeListVersionIDField = "1.0";
			codeListSchemeURIField = "urn:oasis:names:tc:ubl:codelist:SubstitutionStatusCode:1:0";
			languageIDField = "en";
		}
