...
namespace Spinit.Wpc.Synologen.Svefaktura.Svefakt2.UBL.Codelist {
	...
	[System.Xml.Serialization.XmlType(Namespace="urn:oasis:names:tc:ubl:codelist:DocumentStatusCode:1:0")]
	public class DocumentStatusCodeType {
		...
		public DocumentStatusCodeType() {
			codeListIDField = "Document Status";
			codeListAgencyIDField = "UBL";
			codeListAgencyNameField = "OASIS Universal Business Language";
			codeListNameField = "Document Status";
			codeListVersionIDField = "1.0";
			codeListSchemeURIField = "urn:oasis:names:tc:ubl:codelist:DocumentStatusCode:1:0";
			languageIDField = "en";
		}
