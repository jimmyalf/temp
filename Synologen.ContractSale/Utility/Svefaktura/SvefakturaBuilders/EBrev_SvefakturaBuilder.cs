...
{
    public class EBrev_SvefakturaBuilder : ISvefakturaBuilder
    {
        ...
        public EBrev_SvefakturaBuilder(ISvefakturaFormatter formatter, ISvefakturaConversionSettings settings, ISvefakturaBuilderValidator builderValidator)
        {
