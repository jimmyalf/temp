...
namespace Spinit.Wpc.Forum.Components {
    ...
    public class SiteSettings {
        ...
        private string defaultSiteDescription = "An Open Source Forums managed by <a target=\"_blank\" href=\"http://www.telligentsystems.com/Solutions/Products.aspx\">Telligent Systems, Inc.</a>";
        private string defaultTheme = "default";
        private string defaultSiteName = "Community Server :: Forums";
        ...
        private string defaultAnonymousCookieName = "AspNetAnonymous";
		private string defaultCookieDomain = "localhost";
		private int defaultAnonymousUserOnlineTimeWindow = 15;
        private int defaultAvatarHeight = 80;
        private int defaultAvatarWidth = 80;
        private int defaultRoleCookieExpiration = 20;
		private string defaultRoleCookieName = "AspNetRoles";
        private bool defaultEnableAnonymousPosts = false;
        private bool defaultEnableAvatars = true;
        private bool defaultEnableDebugMode = false;
        private bool defaultEnableEmoticons = true;
        private bool defaultEnableRemoteAvatars = true;
		...
		private string defaultAllowedAttachmentTypes = "zip;cab;jpg;gif;png;mpg;mpeg;avi;wmv;wma;mp3;ra;rm;sql;txt";
...
//                settings["ForumsDisabled"] = value;
        ...
        public UserPasswordFormat PasswordFormat {
            get {
                ...
                if (settings[key] != null)
                    return (UserPasswordFormat) settings[key];
                else
                    return UserPasswordFormat.MD5Hash;
            }
            set {
...
//		}
        ...
        public bool EnableAnonymousPosts {
            get {
                string key = "EnableAnonymousPosts";

                if (settings[key] != null)
                    return (bool) settings[key];
                else
                    return defaultEnableAnonymousPosts;
            }
            set {
                settings["EnableAnonymousPosts"] = value;
            }
        }
        ...
        public static SiteSettings GetSiteSettings (string applicationName) {
            ...
            return dp.LoadSiteSettings(applicationName);
        }
