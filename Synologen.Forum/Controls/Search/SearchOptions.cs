...
namespace Spinit.Wpc.Forum.Controls.Search {
        ...
        override protected void InitializeSkin(Control skin) {
            ...
            if (null != forumList) {
                ...
                if (AllowSearchAllForums)
                    forumList.Items.Insert(0, new ListItem(Spinit.Wpc.Forum.Components.ResourceManager.GetString("Search_SearchOptions_AllForums"), "-1"));
            }

            // What are we searching for posts or users?
            searchType = (DropDownList) skin.FindControl("SearchType");
            if (null != searchType) {
                searchType.Items.Add(new ListItem(Spinit.Wpc.Forum.Components.ResourceManager.GetString("Search_SearchOptions_Posts"), "0"));
                searchType.Items.Add(new ListItem(Spinit.Wpc.Forum.Components.ResourceManager.GetString("Search_SearchOptions_PostedBy"), "1"));
            }

            matchType = (DropDownList) skin.FindControl("MatchType");
            if (null != matchType) {
                matchType.Items.Add(new ListItem(Spinit.Wpc.Forum.Components.ResourceManager.GetString("Search_SearchOptions_MatchAll"), "0"));
                matchType.Items.Add(new ListItem(Spinit.Wpc.Forum.Components.ResourceManager.GetString("Search_SearchOptions_MatchAny"), "1"));
                matchType.Items.Add(new ListItem(Spinit.Wpc.Forum.Components.ResourceManager.GetString("Search_SearchOptions_MatchExact"), "2"));	
            }
