            ...
            <table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
              <tr valign="top">
                ...
                <td id="CenterColumn" Width="95%" runat="server" class="CenterColumn">
                  <br>
<%--                  <Forums:NavigationMenu id="NavigationMenu2" SkinFilename="Moderation/Skin-Navigation.ascx" title="ASP.NET Discussion Forum" runat="server" Description="A free discussion system for ASP.NET" /> --%>
