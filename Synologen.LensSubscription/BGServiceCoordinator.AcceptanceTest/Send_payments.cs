...
using SendPaymentsTask = Synologen.LensSubscription.BGServiceCoordinator.Task.SendPayments.Task;
	...
	public class When_sending_payments : TaskTestBase
	{
		...
		public When_sending_payments()
		{
			Context = () =>
			{
				...
				task = ResolveTask<SendPaymentsTask>();
