...
namespace Synologen.LensSubscription.ServiceCoordinator.Tasks
{
	public class ReceivePaymentsTask : TaskBase
	{
		...
		public ReceivePaymentsTask(IBGWebService bgWebService, ITransactionRepository transactionsRepository, ISubscriptionErrorRepository subscriptionErrorRepository, ISubscriptionRepository subscriptionRepository, ILoggingService loggingService)
