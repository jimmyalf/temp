...
using Spinit.Wpc.Synologen.Presentation.Intranet.AcceptanceTest.App.IoC;
using StructureMap;

namespace Spinit.Wpc.Synologen.Presentation.Intranet.AcceptanceTest.App.Bootstrapping
{
