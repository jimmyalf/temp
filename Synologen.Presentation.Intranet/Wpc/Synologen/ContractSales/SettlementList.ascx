...
<tr>
	<td><%=ShopNumber %></td>
	<td>
		<a href="<%=Spinit.Wpc.Synologen.Business.Globals.ViewSettlementPage%>?settlementId=<%# DataBinder.Eval(Container.DataItem, "cId") %>" title="<%# DataBinder.Eval(Container.DataItem, "cCreatedDate","{0:yyyy-MM-dd}") %>">
			Period <%# GetSettlementPeriodNumber((System.Data.DataRowView)Container.DataItem)%>
		</a>
	</td>
</tr>
</ItemTemplate>
