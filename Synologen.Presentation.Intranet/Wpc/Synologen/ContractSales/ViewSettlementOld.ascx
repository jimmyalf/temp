<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewSettlementOld.ascx.cs" Inherits="Spinit.Wpc.Synologen.Presentation.Intranet.Wpc.Synologen.ContractSales.ViewSettlementOld" %>
...
<div class="synologen-control">
	<fieldset><legend>Utbetalningsuppgifter</legend>
		...
		<a href="<%=SynologenSessionContext.SettlementListPage %>">&laquo;&nbsp;Tillbaka</a><br /><br />
	</fieldset><br />
