<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateCustomer.ascx.cs" Inherits="Spinit.Wpc.Synologen.Presentation.Intranet.Wpc.Synologen.LensSubscriptions.CreateCustomer" %>
