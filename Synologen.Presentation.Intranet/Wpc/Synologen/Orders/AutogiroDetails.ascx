   ...
   <div id="tab-container">
	   <fieldset>
    		...
    		<p>
				...
				<asp:RangeValidator  runat="server" MinimumValue="0" MaximumValue="99000" ControlToValidate="txtProductAmount" ErrorMessage="Angivet belopp ligga i intervallet 0 - 99000" CssClass="error-message">*</asp:RangeValidator>
    		</p>
    		<p>
    			<label>Arvode</label>
				...
				<asp:RangeValidator runat="server" MinimumValue="0" MaximumValue="99000" ControlToValidate="txtFeeAmount" ErrorMessage="Angivet belopp ligga i intervallet 0 - 99000" CssClass="error-message">*</asp:RangeValidator>
    		</p>
    		<p>
