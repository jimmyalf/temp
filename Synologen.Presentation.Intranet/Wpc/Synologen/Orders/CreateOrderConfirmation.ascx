...
<div id="page" class="step6">
	...
	<div id="tab-container">
		...
		<fieldset class="right-eye">
			...
			<p><label>Antal boxar</label><input disabled="disabled" value="<%=Model.QuantityRight%>" /></p>
		...
		<fieldset class="left-eye">
			...
			<p><label>Antal boxar</label><input disabled="disabled" value="<%=Model.QuantityLeft%>" /></p>
		...
		<fieldset>
			...
			<p><label>Produktpris</label><input disabled="disabled" value="<%=Model.ProductPrice%>" /></p>
		...
		<fieldset>
			...
			<div class="next-step">
				...
				<asp:Button ID="btnNextStep" runat="server" Text="Bekräfta" CssClass="submit-button" />
			</div>
		</fieldset>
	</div>
</div>