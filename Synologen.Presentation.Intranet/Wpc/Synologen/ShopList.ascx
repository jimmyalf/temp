<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShopList.ascx.cs" Inherits="Spinit.Wpc.Synologen.Presentation.Intranet.Wpc.Synologen.ShopList" %>
...
<tr class="shop-equipment-row"><td colspan="2">Vi erbjuder:&nbsp;<%# DataBinder.Eval(Container.DataItem, "cEquipment") %></td></tr>
</asp:PlaceHolder>
</ItemTemplate>
