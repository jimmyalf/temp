<%@ Control Language="C#" AutoEventWireup="true" Inherits="Spinit.Wpc.Synologen.Presentation.Intranet.Wpc.Synologen.Supplier.AdminMemberNews" Codebehind="AdminMemberNews.ascx.cs" %>
<div>
...
<asp:GridView ID="gvNews" 
		...
		<br /><br />
        <WPC:WpcWysiwyg ID="txtBody" runat="server" Width="500" Mode="BasicText" /></b>
