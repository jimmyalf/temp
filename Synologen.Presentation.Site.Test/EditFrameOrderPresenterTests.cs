...
namespace Spinit.Wpc.Synologen.Presentation.Site.Test
{
	...
	public class Given_a_EditFrameOrderPresenter : WpcAssertionHelper
	{
		...
		public void When_View_Is_Loaded_Model_Has_Expected_Values()
		{
			...
			Expect(view.Model.PupillaryDistance.List.ToList()[0].Value, Is.EqualTo(int.MinValue.ToString("N2")));
			...
			Expect(view.Model.Sphere.List.ToList()[0].Value, Is.EqualTo(int.MinValue.ToString("N2")));
			...
			Expect(view.Model.Cylinder.List.ToList()[0].Value, Is.EqualTo(int.MinValue.ToString("N2")));
			...
			Expect(view.Model.Addition.List.ToList()[0].Value, Is.EqualTo(int.MinValue.ToString("N2")));
			...
			Expect(view.Model.Height.List.ToList()[0].Value, Is.EqualTo(int.MinValue.ToString("N2")));
