<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditCustomer.ascx.cs" Inherits="Spinit.Wpc.Synologen.Presentation.Site.Wpc.Synologen.LensSubscriptions.EditCustomer" %>
