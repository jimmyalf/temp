<%@ Control Language="C#" AutoEventWireup="true" Inherits="Spinit.Wpc.Synologen.Presentation.Site.Wpc.Synologen.Supplier.MemberFilesThumbs" Codebehind="MemberFilesThumbs.ascx.cs" %>
...
<asp:DataList ID="dlThumbs" runat="server" OnDataBinding="dlThumbs_DataBinding" OnItemDataBound="dlThumbs_ItemDataBound" RepeatColumns="3">
	<ItemTemplate>
		...
		<%--<tc:thumbnail id="Thumbnail1" path="pdfthumbnail.pdf" index="1" runat="server"></tc:thumbnail>--%>
