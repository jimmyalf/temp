<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MiniYammerFeed.ascx.cs" Inherits="Spinit.Wpc.Synologen.Presentation.Site.Wpc.Synologen.Yammer.MiniYammerFeed" %>
