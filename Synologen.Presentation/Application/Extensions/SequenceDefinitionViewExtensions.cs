...
namespace Spinit.Wpc.Synologen.Presentation.Application.Extensions
{
	...
	{
		public static IEnumerable<ValidationError> GetValidationErrors<TType>(this TType input, Expression<Func<TType,SequenceDefinitionView>> propertyExpression, bool allowAllNull = false) where TType : class
		{
			...
			return sequence.GetValidationErrors(propertyName, allowAllNull);
		}
	}
}