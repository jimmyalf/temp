...
<%@ Register Src="ListProductCategoryFiles.ascx" TagName="ListProductFiles" TagPrefix="uc5" %>
...
<div class="wrap">
	...
	<fieldset>
		...
		<div class="formItem">
			<asp:PlaceHolder ID ="phProductCategoryFiles" Visible="false" runat="server">
				<asp:UpdatePanel runat="server" ID="updEditFileConnection">
				<ContentTemplate>
				<div class="formItem clearLeft">
					<label for="<%=ucListProductCategoryFiles.ClientID%>" class="labelLong">Attached files</label>
					<uc5:ListProductFiles ID="ucListProductCategoryFiles" runat="server" />
				</div>	
				</ContentTemplate>						
				</asp:UpdatePanel>	
