<%@ Control Language="C#" AutoEventWireup="true" Inherits="Spinit.Wpc.Commerce.Presentation.ProductImage" Codebehind="ProductImage.ascx.cs" %>
<div class="SpotImage-ascx">
    <div>
        <asp:Image ID="imgThumb" runat="server" /><br />
        ...
        <div class="selectSpotWrap" >
            ...
            <div class="selectSpotList">
                ...
                <asp:GridView ID="gvFiles" runat="server" SkinID="Striped" AutoGenerateColumns="false"  DataKeyNames="Id" OnSelectedIndexChanged="gvFiles_SelectedIndexChanged" Width="260">
                    ...
                    <ItemTemplate>
                        <img src='<%# DataBinder.Eval(Container.DataItem, "Pic") %>' border="0" height="<%# (DataBinder.Eval(Container.DataItem, "Directory") != "1")?"30":"" %>" width="<%# (DataBinder.Eval(Container.DataItem, "Directory") != "1")?"30":"" %>" />
                    </ItemTemplate>
