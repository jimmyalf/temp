<%@ Control Language="C#" AutoEventWireup="true" Inherits="Spinit.Wpc.News.Presentation.Components.News.AddComponent.NewsFull" Codebehind="NewsFull.ascx.cs" %>
<div class="Component-News-AddComponent-NewsFull-ascx fullBox">
<div class="wrap">
	<fieldset>
