<%@ Control Language="C#" AutoEventWireup="true" Inherits="Spinit.Wpc.News.Presentation.components.News.add_component.RssLink" Codebehind="RssLink.ascx.cs" %>
<div class="Component-News-AddComponent-RssLink-ascx fullBox">
<div class="wrap">
	<fieldset>
