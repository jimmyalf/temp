...
using Synologen.LensSubscription.ServiceCoordinator.Task.ReceiveConsents;
...
namespace Synologen.Service.Client.SubscriptionTaskRunner.AcceptanceTest
{
	...
	public class When_receiveing_a_successful_consent : TaskBase
	{
		...
		public void Task_updates_subscription_as_consented()
		{
			...
			fetchedSubscription.ConsentedDate.ShouldBe(_consentedConsent.ConsentValidForDate);
		}
