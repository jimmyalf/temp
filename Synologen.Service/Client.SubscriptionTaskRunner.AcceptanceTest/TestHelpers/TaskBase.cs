...
namespace Synologen.Service.Client.SubscriptionTaskRunner.AcceptanceTest.TestHelpers
{
	public abstract class TaskBase : BehaviorActionTestbase
	{
		...
		{
			return Spinit.Wpc.Core.Dependencies.NHibernate.NHibernateFactory.Instance.GetSessionFactory().OpenSession();
		}
